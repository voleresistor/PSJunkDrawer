...
# Prerequisite: Install a certificate in "CERT:\LocalMachine\MY\" store. Find thumbprint by matching the correct cert in 'ls "CERT:\LocalMachine\MY\"' and copying from there.
...
# =================================== Section Pull Server =================================== #
configuration RegisterDSCPullServer
{
    param 
    (
...
# Client config is handled by other scripts
<# =================================== Section DSC Client =================================== #
