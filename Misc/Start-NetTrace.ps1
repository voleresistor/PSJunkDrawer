...
$computers=(Get-Content -Path "C:\Temp\Traces\ComputerList.txt")

#Specify a timestamp to separate multiple traces
$timeStamp=((Get-Date).ToString('MMddyy-HHmm'))
